...
const R = {
  ...
  thornmarsh: {
    ...
    ground: { id: 'gnd_ash_over_peat', albedo: '#9E9584', roughness: 0.97, name: 'ash-dusted peat, pale as a cold hearth' },
    fog: { colour: '#A9A192', extinction_per_m: 0.0075, height_falloff_m: 110 },
  ...
  'valus-ridge': {
    ...
    ground: { id: 'gnd_cliff_limestone', albedo: '#93A2AC', roughness: 0.78, name: 'wind-holed limestone and scree' },
