...
const predicates={
  ...
  hierarchicalSettlementOccupation:settlementOccupationGate.result==='GREEN'&&settlementOccupationGate.population?.clusters===56&&settlementOccupationGate.population?.modules===810&&settlementOccupationGate.deleteControl?.regionalRoutePartsRetained===1876,
