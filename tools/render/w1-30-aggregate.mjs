...
const predicates={
  ...
  regionalSettlementPublicRealm:settlementRealmGate.result==='GREEN'&&settlementRealmGate.population?.approachOccupationClusters===56&&settlementRealmGate.population?.clearApproaches===8&&settlementRealmGate.deleteControl?.formerRunwaySlabsRestored===112&&settlementRealmGate.deleteControl?.fixedSouthwestCollisions===6,
  sharedSettlementFacadeRelief:settlementFacadeGate.result==='GREEN'&&settlementFacadeGate.population?.settlements===8&&settlementFacadeGate.population?.ordinaryBuildings===settlementFacadeGate.population?.relievedBuildings&&settlementFacadeGate.deleteControl?.removedBuildings===settlementFacadeGate.population?.ordinaryBuildings,
  hierarchicalSettlementOccupation:settlementOccupationGate.result==='GREEN'&&settlementOccupationGate.population?.clusters===56&&settlementOccupationGate.population?.modules===810&&settlementOccupationGate.population?.minimumClearance>=.15&&settlementOccupationGate.deleteControl?.regionalRoutePartsRetained===1876,
