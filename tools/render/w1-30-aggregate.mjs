...
const predicates={
  ...
  hierarchicalSettlementOccupation:settlementOccupationGate.result==='GREEN'&&settlementOccupationGate.population?.clusters===56&&settlementOccupationGate.population?.modules===488&&settlementOccupationGate.deleteControl?.regionalRoutePartsRetained===1876,
