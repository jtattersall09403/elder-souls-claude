...
const assetGate=run('tools/render/w1-30-assets.mjs'),populationGate=run('tools/render/w1-30-visual-populations.mjs'),traversalGate=run('tools/render/w1-30-traversal-controls.mjs'),settlementGate=run('tools/render/w1-30-settlement-construction.mjs'),settlementBatchGate=run('tools/render/w1-30-settlement-batching.mjs'),settlementRealmGate=run('tools/render/w1-30-settlement-public-realm.mjs'),settlementFacadeGate=run('tools/render/w1-30-settlement-facades.mjs');
const predicates={
