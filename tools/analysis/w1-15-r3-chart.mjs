...
//
// No browser, no engine. The PNG writer is lifted from tools/analysis/w1-13-r4-chart.mjs; the font
// is the shared `tools/lib/chart-font.mjs` (it used to be a local copy of the sheared table).
...
// The shared 5x5 chart font. This tool used to carry its own copy of the 23-character sheared
// table; see tools/lib/chart-font.mjs, which throws on a row of the wrong width.
