...
// ---------------------------------------------------------------------------------------------
// THE AUTHORED SHELF. 60 coordinates in the parameter space. `p` = purchasable.
// Tier mix is asserted at the bottom against RI-MAG02's requested 26/18/10/5/1.
// ---------------------------------------------------------------------------------------------
...
const SHELF = [
  ...
  { id: 'ember_spit', name: 'Ember-Spit', cls: 'CANTRIP', range: 'projectile', fx: [E('fire_damage', 14, 3)] },
  { id: 'rime_touch', name: 'Rime-Touch', cls: 'CANTRIP', range: 'touch', fx: [E('frost_damage', 16, 2)] },
  ...
  { id: 'leech', name: 'Leech', cls: 'LIGHT', range: 'touch', fx: [E('drain_health', 40, 30)] },
  { id: 'sap_thief', name: 'Sap-Thief', cls: 'LIGHT', range: 'touch', fx: [E('absorb_health', 26)] },
  { id: 'root_theft', name: 'Root-Theft', cls: 'LIGHT', range: 'target', fx: [E('soul_trap', 30, 30)], note: 'xul-hesh. RI-LOR05 §3; every cast increments the counter.' },
  { id: 'shell_splitter', name: 'Shell-Splitter', cls: 'HEAVY', range: 'projectile', fx: [E('shatter', 60)] },
  { id: 'verdigris', name: 'Verdigris', cls: 'LIGHT', range: 'touch', fx: [E('corrode', 40)] },
  { id: 'call_the_drowned', name: 'Call the Drowned', cls: 'HEAVY', range: 'self', fx: [E('bind_lesser', 60, 60)] },
  { id: 'call_the_deep_drowned', name: 'Call the Deep-Drowned', cls: 'GREAT', range: 'self', fx: [E('bind_greater', 60, 60)] },
  { id: 'sap_blade', name: 'Sap-Blade', cls: 'LIGHT', range: 'self', fx: [E('bound_weapon', 180, 180)], note: 'MB-6: an early-game power spike with no upgrade path.' },
  ...
  { id: 'the_greater_mending', name: 'The Greater Mending', cls: 'LIGHT', range: 'self', fx: [E('restore_health', 70)] },
  ...
  { id: 'thick_skin', name: 'Thick Skin', cls: 'CANTRIP', range: 'self', fx: [E('resist_element', 20, 60)] },
  { id: 'clean_lungs', name: 'Clean Lungs', cls: 'CANTRIP', range: 'self', fx: [E('resist_disease', 20, 120)] },
  { id: 'the_hists_patience', name: "The Hist's Patience", cls: 'GREAT', range: 'self', fx: [E('sap_ward', 1)] },
  { id: 'ask_the_dead', name: 'Ask the Dead', cls: 'RITUAL', range: 'touch', fx: [E('speak_to_the_dead', 48)], note: 'X2: a corpse produced by a fight becomes a requires.knowledge key.' },
  ...
  { id: 'make_it_whole', name: 'Make It Whole', cls: 'LIGHT', range: 'touch', fx: [E('mend_item', 45)] },
  { id: 'still_the_beast', name: 'Still the Beast', cls: 'LIGHT', range: 'target', fx: [E('calm_beast', 30, 30)], note: 'X1 / MB-10: a fight that ends with no corpse.' },
  { id: 'the_long_stillness', name: 'The Long Stillness', cls: 'HEAVY', range: 'area_at_range', fx: [E('calm_beast', 45, 45, 6)] },
  ...
  { id: 'seal', name: 'Seal', cls: 'CANTRIP', range: 'touch', fx: [E('lock_lock', 40)] },
  ...
  { id: 'feather', name: 'Feather', cls: 'CANTRIP', range: 'self', fx: [E('feather', 60, 120)], note: 'X4: moves the player across RI-CMB01\'s LIGHT/MEDIUM roll cliff mid-fight.' },
  { id: 'burden', name: 'Burden', cls: 'LIGHT', range: 'target', fx: [E('burden', 70, 40)], note: 'Moves the enemy\'s equip-load tier. NEVER its windup, tracking cutoff, hitbox or telegraph.' },
  ...
  { id: 'stone_skin', name: 'Stone-Skin', cls: 'LIGHT', range: 'self', fx: [E('shield', 50, 60)] },
  { id: 'the_broken_wall', name: 'The Broken Wall', cls: 'HEAVY', range: 'area_at_range', fx: [E('wall', 60, 30, 4)] },
  ...
  // ---- Veiling -------------------------------------------------------------------------------
  { id: 'the_water_film', name: 'The Water-Film', cls: 'LIGHT', range: 'self', fx: [E('invisibility', 30, 30)] },
  ...
  { id: 'muffle', name: 'Muffle', cls: 'CANTRIP', range: 'self', fx: [E('muffle', 20, 120)] },
  ...
  { id: 'night_eye', name: 'Night-Eye', cls: 'CANTRIP', range: 'self', fx: [E('night_eye', 18, 180)] },
  { id: 'warm_smudges', name: 'Warm Smudges', cls: 'LIGHT', range: 'self', fx: [E('detect_life', 40, 60)], note: 'Diegetic smudges at real world positions. No icons, no compass, no names.' },
  { id: 'the_key_sense', name: 'The Key-Sense', cls: 'LIGHT', range: 'self', fx: [E('detect_key', 40, 60)] },
  { id: 'charm', name: 'Charm', cls: 'CANTRIP', range: 'touch', fx: [E('charm', 20, 60)] },
  ...
  { id: 'false_face', name: 'False Face', cls: 'HEAVY', range: 'self', fx: [E('false_face', 180, 180)] },
  { id: 'the_borrowed_scale', name: 'The Borrowed Scale', cls: 'HEAVY', range: 'self', fx: [E('false_face', 120, 120), E('muffle', 20, 120)], note: 'Two effects, two schools\' worth of intent: get in, and be quiet while you are in.' },
];
...
for (const s of SHELF) {
  ...
  const rec = {
    ...
    // Tiers 4-5 are NOT on a shelf. See the amendment note at the foot of spells.json.
    purchasable: t.tier <= 3,
...
const out = {
  ...
  amendment_requested: {
    id: 'AM-W1-14-01',
    owner: 'RI-MAG02 / RI-MAG03 / RI-PRG05',
    claim: "RI-MAG02's provenance note requests the magic line be pinned at '≈28,000 g across 60 purchasable spells (tier mix 26/18/10/5/1)', and RI-MAG03 M8 asserts that total within ±15%. Those two numbers cannot both be true under RI-MAG02 §D's own price formula.",
    arithmetic: "At RI-PRG05 §2's published band prices — tier-1 220, tier-2 900, tier-3 3,400 — plus RI-MAG02's own derived tier-4 8,350 and tier-5 22,200, a 26/18/10/5/1 shelf costs 26×220 + 18×900 + 10×3,400 + 5×8,350 + 1×22,200 = 5,720 + 16,200 + 34,000 + 41,750 + 22,200 = 119,870 g. That is 4.3× the 28,000 target and 78% of RI-PRG05's entire 152,900-gold discretionary menu. Bottom-loading every band does not close it: the cheapest legal 26/18/10/5/1 shelf is still over 60,000 g, because one tier-5 spell alone is 17,300 g at the band floor.",
    resolution_shipped: 'Tiers 4 and 5 are NOT purchasable. They are commissioned at a spellwright (RI-MAG03 §A, 1.6× + 150 g) or hand-placed (S12). This is also what Morrowind does — the top spells are not shop stock — and it is the smallest change that reconciles the two numbers. All 60 spells ship; 54 are on a shelf.',
    measured_shelf_total_g: shelfGold,
    note: 'Filed rather than silently satisfied. If the owners prefer the 60-purchasable reading, the 28,000 figure must move, not the shelf.',
  },
  cost_model: {
...
if (process.argv.includes('--check')) {
  ...
  console.log(`shelf gold ${shelfGold} over ${out.census.purchasable} purchasable spells; all 60 = ${allGold}`);
}
