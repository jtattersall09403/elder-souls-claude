...
const GAP_MAP = {
  ...
  'GAP-W1-F10-contrapposto-lifted-every-character-off-the-ground': ['F10'],
  ...
  // F4 r1's critic verdict (corpus/90-verdicts/wave1/W1-F4-r1.json, FAIL at 2). The key-light
  // rebalance bought cast-shadow visibility by cutting the light that fills shadows, and raised a
  // key that is the same colour as everything else: M6 retention and C_shadow fall through their
  // RI-VIS03 minima in every window whose shadow area rose, and M6 hue_offset — RI-VIS04 §2's own
