...
**STRUCK B-01 — The potion ladder (alchemy self-amplification).** `Sys ✔`
...
**STRUCK B-02 — Fortify-skill stacking into a rank you have not earned.** `Sys ✔`
...
**STRUCK B-03 — The utility spell that skips a designed route.** `Sys ✔`
...
**STRUCK B-04 — Sequence break into a late region at level 1.**
