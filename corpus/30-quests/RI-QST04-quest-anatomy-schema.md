...
| `AM-QST04-W1-18-03` | wave 1, complete builder | Existing authored quest vocabulary and legacy deceit shapes | Keeps `additionalProperties: false` while registering the already consumed resolution methods, task kinds, rank/spell conditions, faction joins, reveal alternatives and provenance notes; legacy deceit rows are migrated to the required explicit pattern/objective/PONR shape. This closes check 0 at 202/202 without weakening validation. |
