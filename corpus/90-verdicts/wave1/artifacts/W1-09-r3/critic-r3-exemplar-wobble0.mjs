...
import { parseArgs, wantsHelp, usage, log, REPO_ROOT } from '/home/user/elder-souls-claude/tools/lib/cli.mjs';
import { launchGame, requireMethods } from '/home/user/elder-souls-claude/tools/lib/browser.mjs';
...
const WOBBLE = args.wobble !== undefined ? Number(args.wobble) : null;
if (WOBBLE !== null) for (const p of PROFILES) p.wobble = WOBBLE;
