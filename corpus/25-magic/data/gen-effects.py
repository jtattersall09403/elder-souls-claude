...
eff(id="levitate", name="Standing Off the Ground", school="warding", weight=9.0, mag_unit="unit",
    ...
    rulings=[
      ...
      "NEUTRAL BUOYANCY, NOT THRUST. Horizontal drift 1.4 m/s - SLOWER than the 2.0 m/s walk speed S17 fixes. Levitation is a route-opener, never a time-saver over open ground, and therefore never competes with the S7 travel network.",
      "This does NOT conflict with RI-EXP06 PB-03's '<40% of the walked time' test, which is about VERTICAL objectives. Levitation is slower per metre travelled and collapses the metres: a roof reached by 400 m of stairs is 12 m of climb at 0.8 m/s. The straight line is what is cheap, never the speed.",
      ...
      "THE CANOPY IS NOT A BLOCKING VOLUME (RI-EXP06 PB-03 explicitly reds on one). It is authored, visible, renderable tree geometry with the same collider every arrow and every falling body uses. It has GAPS - clearings, river channels, burn scars, the xanmeer plazas - and you can fly up through them and over the top. It blocks nothing that a physical canopy would not block, and a critic can see it in the frame.",
