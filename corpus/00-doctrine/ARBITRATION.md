...
| I-frame accounting | Every dodge measured in frames at 60fps, not seconds. **UNIT WARNING (added wave 0, corpus-audit): Souls community frame counts — DS1, DS3 and Elden Ring alike — are quoted in 1/30-second ticks. A Souls figure of N frames is 2N of ours. No frame count in this corpus may be compared to a Souls frame count without that factor.** See `RI-CMB01` §A and `CORPUS-COHERENCE-01.md` §9 |
