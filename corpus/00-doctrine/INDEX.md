...
Generated: 2026-08-05T22:58:12Z
...
- Reference items found: **64** across 8 area(s)
...
| `render.fidelity.character` | Character and creature mesh/texture quality up close | modern-fidelity | [RI-VIS08](../../corpus/70-visual/RI-VIS08-character-animation-fidelity.md) | `critic.fidelity` | in-item procedure (kind: number); corpus/80-methods/capture-trace.mjs, corpus/80-methods/anim-metrics.mjs |
| `render.fidelity.animation` | Animation quality: weight, blending, foot contact | modern-fidelity | [RI-VIS08](../../corpus/70-visual/RI-VIS08-character-animation-fidelity.md) | `critic.fidelity` | in-item procedure (kind: number); corpus/80-methods/capture-trace.mjs, corpus/80-methods/anim-metrics.mjs |
