# Blind comparison — W1-PROSE-TICS, trial 11 of 15 (journal)

You are judging two sets of quest-journal entries. You do **not** know where either came from and you must not try
...
Write your answer to `../../prose-tics-r5.answers/<your-agent-id>/t11-journal.md` — **outside the pack**,
