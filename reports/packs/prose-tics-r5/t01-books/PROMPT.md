# Blind comparison — W1-PROSE-TICS, trial 1 of 15 (books)

You are judging two passages of in-world book prose. You do **not** know where either came from and you must not try
...
Write your answer to `../../prose-tics-r5.answers/<your-agent-id>/t01-books.md` — **outside the pack**,
