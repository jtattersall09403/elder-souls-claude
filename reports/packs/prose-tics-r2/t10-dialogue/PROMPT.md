# Blind comparison — W1-PROSE-TICS round 2, trial 10 (dialogue)

You are judging two passages of spoken NPC dialogue.
...
Which set of lines was written by a game writer for a shipped RPG, and which is placeholder? Quote the lines that decided it.
