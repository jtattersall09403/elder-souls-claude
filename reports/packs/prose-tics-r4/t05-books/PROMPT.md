# Blind comparison — W1-PROSE-TICS round 2, trial 5 (books)

You are judging two passages of in-world book prose.
...
Which of these two is the work of a game writer for a shipped RPG, and which is placeholder? Quote the lines that decided it.
