...
> Generated 2026-08-16T00:18:10.447Z against baseline `dd222b7951a6d0564c992bb6d39b783f0f293188`.
...
| `RI-VIS04` | 70-visual | modern-fidelity | F5 F2 F3 F4 | 8 | 8 | judged_at_or_above_bar |
...
| `RI-VIS08` | 70-visual | modern-fidelity | F10 F11 | 5 | 3 | judged_below_bar |
| `RI-VIS09` | 70-visual | neutral | I5 | 0 | — | never_judged |
| `RI-VIS10` | 70-visual | morrowind | F10 I5 | 3 | 2 | judged_below_bar |
...
| `GAP-W1-visual-fix-not-reaching-blind-frames` | blocking | `render.process.measurement` | F4 F2 F3 |
