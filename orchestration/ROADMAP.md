...
| `F7` | The water surface | **In flight.** Axis-aligned 20 m light/dark lanes, proven *not* a shadow artefact — ρ 0.990 with every shadow off against a 0.957 restore floor; hiding the water collapses them to 0.335 and removes 42% of their energy. `render/water.js`'s own header records the defect its crossed-wave field was written to remove. |
