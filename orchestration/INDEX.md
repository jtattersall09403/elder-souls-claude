...
drift. At `f3d20968`: **1084 tools**, **160 reference items**,
**61 pieces in flight**.
...
|---|---|
| does a tool for this already exist? | `grep -i <word> orchestration/index/TOOLS.md` — all 1084, one line each |
