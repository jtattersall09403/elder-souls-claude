...
so it cannot drift. Generated at `bafda07`: 802 tools, 153 reference
items, 128 pieces in flight.

Its purpose is to stop 128+ concurrent agents each paying separately to discover the
...
|---|---|---|---|
| `W1-23-builder-codex-20260810` | committed_pending_pr | Open the PR to codex/wave1-build-experiment when a GitHub-authenticated make_pr surface is | `corpus/60-lore/data/canon-facts.json` `corpus/60-lore/data/jel-lexicon.json` `corpus/80-methods/book-stats.py` `game/data/books/manifest.json` `game/data/lore/canon.json` `game/data/npcs/mainline.json` |
