...
drift. At `398bd592`: **1046 tools**, **160 reference items**,
**56 pieces in flight**.
...
|---|---|
| does a tool for this already exist? | `grep -i <word> orchestration/index/TOOLS.md` — all 1046, one line each |
