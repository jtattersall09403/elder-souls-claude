...
so it cannot drift. Generated at `5f511bb4`: 943 tools, 155 reference
items, 176 pieces in flight.

Its purpose is to stop 176+ concurrent agents each paying separately to discover the
...
> **252 tools have no header comment**, so nobody can tell what they do without
