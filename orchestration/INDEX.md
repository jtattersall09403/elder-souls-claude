...
so it cannot drift. Generated at `3124790`: 547 tools, 153 reference
...
| `W1-01-r4` | building | Crossing arms B (solids off) and C (solids off + deck clamp off) are running in ONE backgr | `tools/world/road-through-building.mjs` `tools/world/hazard-fire.mjs` `game/src/sim/hazards.js` `reports/road-through-building.json` `orchestration/status/W1-01-r4.json` `tools/world/crossing.mjs` |
