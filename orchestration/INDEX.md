...
so it cannot drift. Generated at `9badbe5c`: 926 tools, 155 reference
items, 172 pieces in flight.

Its purpose is to stop 172+ concurrent agents each paying separately to discover the
...
> **244 tools have no header comment**, so nobody can tell what they do without
