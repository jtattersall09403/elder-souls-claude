...
drift. At `770fd363`: **1074 tools**, **160 reference items**,
**62 pieces in flight**.
...
|---|---|
| does a tool for this already exist? | `grep -i <word> orchestration/index/TOOLS.md` — all 1074, one line each |
