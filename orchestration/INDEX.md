...
drift. At `8b9e50f2`: **1008 tools**, **157 reference items**,
**58 pieces in flight**.
...
|---|---|
| does a tool for this already exist? | `grep -i <word> orchestration/index/TOOLS.md` — all 1008, one line each |
