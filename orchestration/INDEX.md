...
|---|---|---|---|
| `W1-19-builder-production-20260811` | ? | Rerun Q-MAIN-08 with the walkable radius-15 crater shelter, then finish intended/backpath  | `orchestration/status/W1-19-builder-production-20260811.json` `game/src/engine.js` `tools/quests/mainline-chain-floor.mjs` `evidence/W1-19/` `game/src/world/signature.js` |
...
| `W1-30` | plan-satisfied |  | `orchestration/status/W1-30.json` `orchestration/plans/W1-30.md` |
