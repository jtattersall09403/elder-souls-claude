...
<<<<<<< HEAD
so it cannot drift. Generated at `bb50bef`: 895 tools, 155 reference
items, 160 pieces in flight.
=======
so it cannot drift. Generated at `bb50befb`: 895 tools, 155 reference
...
> **232 tools have no header comment**, so nobody can tell what they do without
...
|---|---|---|---|
<<<<<<< HEAD
| `COST-EXPERIMENTS-BUILD` | started | Read COST-EXPERIMENTS.md, COST-INSTRUMENT.md, tools/cost.mjs; then add analysis flags to t | `orchestration/status/COST-EXPERIMENTS-BUILD.json` |
