...
drift. At `d9eeefe5`: **1003 tools**, **157 reference items**,
**56 pieces in flight**.
...
|---|---|
| does a tool for this already exist? | `grep -i <word> orchestration/index/TOOLS.md` — all 1003, one line each |
