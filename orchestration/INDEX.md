...
drift. At `186a60e3`: **1054 tools**, **160 reference items**,
**58 pieces in flight**.
...
|---|---|
| does a tool for this already exist? | `grep -i <word> orchestration/index/TOOLS.md` — all 1054, one line each |
