...
so it cannot drift. Generated at `c724e26`: 835 tools, 153 reference
...
`window.__HARNESS` — 432 verbs. `window.__ENGINE` is also published by `main.js`,
...
> **195 tools have no header comment**, so nobody can tell what they do without
