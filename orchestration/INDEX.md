...
drift. At `46421207`: **1058 tools**, **160 reference items**,
**62 pieces in flight**.
...
|---|---|
| does a tool for this already exist? | `grep -i <word> orchestration/index/TOOLS.md` — all 1058, one line each |
