...
so it cannot drift. Generated at `18d003ea`: 968 tools, 157 reference
...
- `tools/cost-reverted-dev.mjs` — tools/cost.mjs — THE COST INSTRUMENT (piece `COST-INSTRUMENT`; contract: orchestration/COST.md §6.1; corrected specification: orchestration/plans/COST-INSTRUMEN
