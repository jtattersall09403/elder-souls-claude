...
drift. At `c6b5ad1f`: **1111 tools**, **160 reference items**,
**62 pieces in flight**.
...
|---|---|
| does a tool for this already exist? | `grep -i <word> orchestration/index/TOOLS.md` — all 1111, one line each |
