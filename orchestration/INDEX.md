...
so it cannot drift. Generated at `45b7617`: 690 tools, 153 reference
...
> **158 tools have no header comment**, so nobody can tell what they do without
...
|---|---|---|---|
| `W1-04-r5` | starting | read spec corpus/90-verdicts/wave1/W1-04-r4.md, ownership, contention gate | — |
