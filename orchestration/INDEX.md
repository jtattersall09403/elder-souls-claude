...
drift. At `c9aefbe5`: **1102 tools**, **160 reference items**,
**61 pieces in flight**.
...
|---|---|
| does a tool for this already exist? | `grep -i <word> orchestration/index/TOOLS.md` — all 1102, one line each |
