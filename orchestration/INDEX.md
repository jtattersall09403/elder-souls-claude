...
so it cannot drift. Generated at `852bb87`: 508 tools, 153 reference
...
> **120 tools have no header comment**, so nobody can tell what they do without
...
| `critic-w1-03` | running | measurement complete; writing corpus/90-verdicts/wave1/W1-03-r1.{md,json}, validating, blo | `orchestration/status/critic-w1-03.json` |
