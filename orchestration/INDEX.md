...
drift. At `7bd6ebc9`: **1039 tools**, **159 reference items**,
**56 pieces in flight**.
...
|---|---|
| does a tool for this already exist? | `grep -i <word> orchestration/index/TOOLS.md` — all 1039, one line each |
