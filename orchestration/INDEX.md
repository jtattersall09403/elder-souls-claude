...
so it cannot drift. Generated at `091a6ce`: 814 tools, 153 reference
items, 137 pieces in flight.

Its purpose is to stop 137+ concurrent agents each paying separately to discover the
...
> **183 tools have no header comment**, so nobody can tell what they do without
