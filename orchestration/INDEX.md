...
so it cannot drift. Generated at `efc31248`: 989 tools, 157 reference
items, 203 pieces in flight.

Its purpose is to stop 203+ concurrent agents each paying separately to discover the
...
> **273 tools have no header comment**, so nobody can tell what they do without
