...
so it cannot drift. Generated at `6c40296`: 841 tools, 153 reference
...
> **198 tools have no header comment**, so nobody can tell what they do without
...
|---|---|---|---|
| `W1-30` | plan-awaiting-recriticism |  | `orchestration/status/W1-30.json` `orchestration/plans/W1-30.md` `corpus/70-visual/RI-VIS09-reference-image-set.md` |
| `W1-06-build` | ? | Critic handoff after the canonical engine blob is repaired by an authoritative merge recov | `corpus/00-doctrine/ARBITRATION.md` `corpus/15-camera/RI-CAM05-camera-outside-the-fight.md` `corpus/80-methods/m-cam02-control.mjs` `evidence/W1-06/builder-ledger.md` `evidence/W1-06/mechanical/cam-consume.json` `evidence/W1-06/mechanical/cam02-final/cam02.json` |
...
| `W1-06` | partial | Dispatch a fresh reviewer-editor for the materially corrected W1-06 plan. Do not dispatch  | `game/src/sim/camera.js` `corpus/80-methods/m-cam01-rig.mjs` `corpus/80-methods/m-cam03-lockon-framing.mjs` `corpus/80-methods/m-cam04-locked-movement.mjs` `corpus/80-methods/m-cam05-world-camera.mjs` `corpus/80-methods/m-cam06-feel.mjs` |
| `W1-19-builder-production-20260811` | ? | Route the production chain runner through the shipped glassed-crater shelter counter durin | `orchestration/status/W1-19-builder-production-20260811.json` `game/src/engine.js` `tools/quests/mainline-chain-floor.mjs` `evidence/W1-19/` |
