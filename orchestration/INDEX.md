...
so it cannot drift. Generated at `87e099c0`: 946 tools, 155 reference
...
`window.__HARNESS` — 445 verbs. `window.__ENGINE` is also published by `main.js`,
which is a **back door**: capability prohibitions installed on the harness do not cover it.

`__breakBindMagnitude`, `__breakCastCredit`, `__breakCastInWater`, `__breakCommissionCounter`, `__breakEnchantCounter`, `__breakEnchantUse`, `__breakFactionRefusalVoice`, `__breakFleeMotion`, `__breakGroundPlane`, `__breakKindBlindWards`, `__breakLead`, `__breakPurseHook`, `__breakRefusalVoice`, `__breakRelativeSweep`, `__breakSkillRegister`, `__breakSummonAlias`, `__breakTouchDedupe`, `__breakTrackingCutoff`, `__breakTravelFence`, `__breakW116`, `__breakWaterPlane`, `__w1_04_content`, `__w1_04_doors`, `__w1_04_drawBuildings`, `__w1_04_interior`, `__w1_04_npc`, `__w1_04_perturbSettlement`, `__w1_04_plan`, `__w1_04_settlement`, `__w1_04_sim`, `__w1_04_system`, `__w1_04_townSolids`, `__w1_04_zone`, `__w1_30_drawGeology`, `__weaponAliasingArmed`, `addAffliction`, `addCoverVolume`, `addLightSource`, `addOccluder`, `addStatusBuildup`, `addWitness`, `addWitnessIndex`, `advanceWallClock`, `aggro`, `ambienceCapture`, `ambienceEmitters`, `ambienceLog`, `answerArrest`, `arrestTopics`, `audioCapture`, `audioLog`, `audioStats`, `boardTravel`, `breakInvisibility`, `brewFortifyAlchemy`, `bribeWitness`, `buildingAt`, `camera`, `cameraRoute`, `cameraRouteEnd`, `cameraRouteState`, `canJoinFaction`, `castCameraArm`, `castNow`, `castSpellAt`, `censusAnswer`, `censusBegin`, `censusEnter`, `clearInputs`, `clearProps`, `closeMenu`, `closeRebinding`, `closeWrit`, `combatTraceDrain`, `combatTraceMeta`, `combatTraceStart`, `combatTraceStop`, `commissionState`, `commitCrime`, `consumeBossOutcome`, `conversationClose`, `conversationPersuade`, `conversationSay`, `coverAt`, `damageEnemy`, `damagePlayer`, `darkCoverage`, `deathCamera`, `deleteSaveSlot`, `despawn`, `discoverCorpse`, `drainStealthEvents`, `drawOnMenus`, `drawSentinels`, `drinkFortifyAlchemy`, `dropFrom`, `eavesdrop`, `emitStealthSound`, `enchantCounterState`, `enchantQuote`, `enchantedItems`, `enchanterOpen`, `enterInterior`, `equipItem`, `examineCorpse`, `exitInterior`, `explainDisposition`, `exportSave`, `factionAccess`, `factionDiscipline`, `factionGates`, `factionReadmit`, `factionRefusal`, `factionRefusalCensus`, `fenceQuote`, `fenceSell`, `fogGate`, `gamepad`, `gamepadPoll`, `getActionSet`, `getAmbienceState`, `getBorderAt`, `getBorderCrossover`, `getBuildInfo`, `getBurden`, `getCameraFrame`, `getCameraRig`, `getCanonState`, `getCapabilityReport`, `getCaptureState`, `getCastEffects`, `getCensusModel`, `getCensusState`, `getCharacter`, `getCombatState`, `getConversationState`, `getCreationData`, `getCrimeState`, `getCrossingControl`, `getDeathState`, `getDerivedStats`, `getDeterminismReport`, `getDevicePixelRatio`, `getDispositions`, `getDrawnGeometry`, `getDrawnInterior`, `getDrawnMarkers`, `getDrawnSettlements`, `getDrawnSignature`, `getDurableFieldCensus`, `getEffectConsumerMap`, `getEncounterState`, `getEnvConditions`, `getEnvironment`, `getFactionStanding`, `getFallState`, `getFogGates`, `getFrame`, `getGateDispositions`, `getGold`, `getGuardBand`, `getGuardTerms`, `getHazardReport`, `getHitGeometry`, `getInputEdges`, `getInputState`, `getInteriorContainment`, `getInteriorContinuity`, `getInventory`, `getJourneyStamps`, `getLightAt`, `getLoadState`, `getMagicData`, `getMagicState`, `getMagicWorld`, `getMoveVector`, `getOpacityState`, `getPerfStats`, `getPlayerStats`, `getPopulationPostPlacement`, `getPriceQuote`, `getProvinceStats`, `getQuestState`, `getReaction`, `getRegionAt`, `getRegionSignature`, `getRenderRate`, `getRenderedText`, `getRespawnRules`, `getRoutes`, `getSanctionState`, `getSapTaint`, `getSaveManifest`, `getSearchState`, `getSeed`, `getSettlementSolids`, `getSignReaderState`, `getSignatures`, `getSkillProgress`, `getSkillSheet`, `getSkills`, `getSpellVFXReport`, `getStateHash`, `getStatus`, `getStatusState`, `getStealthState`, `getStorageInfo`, `getTerrainAt`, `getTide`, `getTitleState`, `getTravelNetwork`, `getTravelState`, `getTraversalReport`, `getUIPauseReport`, `getUIState`, `getViewport`, `getVisualFeatureState`, `getWaterAt`, `getWorldRegisters`, `getWorldStats`, `getWritReaderState`, `getXulHesh`, `goldMirrors`, `grantInventoryItem`, `grantSkillUse`, `grantSoulGem`, `hearthRest`, `importSave`, `isOpenNow`, `isStealthOpener`, `jailLedger`, `killEntity`, `killPlayer`, `killWitness`, `landReport`, `learnSpell`, `learnTopic`, `listAnchors`, `listBorderMarkers`, `listBorders`, `listCameraModes`, `listCivilians`, `listCoverVolumes`, `listEntities`, `listHearths`, `listInteriors`, `listMenus`, `listNPCs`, `listOccluders`, `listOwnedObjects`, `listPendingReports`, `listPerspectiveModes`, `listPropertyZones`, `listSaveSlots`, `listSettlements`, `listSignposts`, `listStations`, `loadState`, `lockBegin`, `lockGate`, `lockOn`, `lockPress`, `lockState`, `lockTolerance`, `losBetween`, `magicEventsDrain`, `magicHitboxes`, `makeSpell`, `mapState`, `npcDisposition`, `openContainer`, `openMenu`, `openRebinding`, `openWrit`, `pauseClock`, `perceptionState`, `perturbInput`, `perturbInputReset`, `pickpocketBegin`, `pickpocketState`, `playerDeath`, `populateSettlement`, `populateSite`, `populationReport`, `pressCast`, `probeWard`, `projectPoint`, `provinceResidency`, `questBook`, `questDef`, `questEndings`, `questEventsDrain`, `questFail`, `questNote`, `questOffers`, `questOpen`, `questPrepareOffer`, `questPresenceGate`, `questResolutionConsequences`, `questResolutionRequirements`, `questResolutions`, `questResolve`, `questReveal`, `questSetFlag`, `questTopicsKnown`, `questVerbCensus`, `questWorldFlags`, `queueEnemyScript`, `queueInputs`, `quoteSpell`, `raiseEnemyAlert`, `readSave`, `readWrit`, `reanchorFreeRunning`, `rebindBegin`, `rebindCommit`, `rebindOffer`, `rebindRestore`, `rebindSerialise`, `rebindStep`, `rebindUnbind`, `rebindView`, `recallQuote`, `recoverBloodstain`, `registerSurfaces`, `renderFrame`, `renderedTextClear`, `reportRoute`, `reset`, `resetAlchemy`, `resetMagicWorld`, `resetSapTaint`, `residentsPresent`, `resolveKilling`, `restAt`, `restoreState`, `saveRoundTrip`, `saveState`, `setAtHearth`, `setAttributes`, `setAttuned`, `setAudioPanSource`, `setAudioTriggerSource`, `setBounty`, `setBurden`, `setCameraCell`, `setCameraObstacle`, `setCatalyst`, `setCharacter`, `setCrimeContext`, `setCrossingControl`, `setDevicePixelRatio`, `setDisposition`, `setEntityNamed`, `setEntityPos`, `setEquipLoad`, `setFactionStanding`, `setFactionStandings`, `setFogGateBoss`, `setGold`, `setHearths`, `setHudMode`, `setInteriorContainment`, `setLevitating`, `setLoadout`, `setMagicSkills`, `setMode`, `setPadProfile`, `setPermissivenessClosure`, `setPlayerMotion`, `setPopulation`, `setRenderRate`, `setRespawnRules`, `setSeed`, `setSkills`, `setStealthState`, `setSyntheticPads`, `setTide`, `setTimeOfDay`, `setTouchEnabled`, `setTravelMark`, `setUIVisible`, `setViewport`, `setVisualFeature`, `setWeather`, `setWillpower`, `setWorldKnowledge`, `setZoneAmbient`, `signClose`, `signRead`, `signatureAudit`, `simulateStorageFailure`, `skipDeathSurface`, `snapshot`, `snuffLight`, `solidAt`, `soundRadiusFor`, `spawn`, `spawnCivilian`, `spawnEncounter`, `spawnGuard`, `spawnNPC`, `spawnProp`, `spellCost`, `stallMainThread`, `stepFrames`, `streamAround`, `syncFactionStandings`, `takeObject`, `takeProp`, `talkDownWitness`, `talkTo`, `teleport`, `titleActivate`, `titleDismiss`, `titleShow`, `touchDown`, `touchLayout`, `touchMove`, `touchState`, `touchUp`, `traceDrain`, `traceStart`, `traceStop`, `trapSoul`, `travelFare`, `travelQuote`, `travelRide`, `travelToGiver`, `trespassCheck`, `triggerCameraShake`, `tryPlaceMapMarker`, `uiClose`, `uiFocus`, `uiOpen`, `uiSearch`, `uiToast`, `useEnchanted`, `visibilityAt`, `walkPath`, `walkRoute`, `warbroodShift`, `whereAmI`, `whereIsEveryone`, `writeSave`
...
> **255 tools have no header comment**, so nobody can tell what they do without
...
| `W1-30E-builder` | built-awaiting-fresh-critic | Dispatch the fresh W1-30E critic: child-scoped Deck profile over the 8 settlement street a | `game/src/render/lib/kits.js` `game/src/render/exterior.js` `tools/render/w1-30e-kit-gate.mjs` `reports/w1-30e/E-DELIVERY.md` |
...
| `runpod-gpu-test-infra` | ? | Use npm run gpu:doctor, npm run gpu:list, then npm run gpu:test; use gpu:cleanup after any | `orchestration/status/runpod-gpu-test-infra.json` `tools/runpod/config.json` `tools/runpod/cli.mjs` `tools/runpod/lib/api.mjs` `tools/runpod/lib/local.mjs` `tools/runpod/worker/bootstrap.sh` |
...
| `plan-review-editor-w1-01-27-16-22-24-06-03` | done | A DIFFERENT fresh reviewer-editor must judge each of the seven edited versions. PLAN-LOOP. | `orchestration/plans/W1-01.md` `orchestration/plans/W1-27.md` `orchestration/plans/W1-16.md` `orchestration/plans/W1-22.md` `orchestration/plans/W1-24.md` `orchestration/plans/W1-06.md` |
...
| `plan-review-editor-w1-15-12-09-08-rulingW2` | done | A DIFFERENT fresh reviewer-editor must judge each of the four edited versions. PLAN-LOOP.m | `orchestration/plans/W1-15.md` `orchestration/plans/W1-12.md` `orchestration/plans/W1-09.md` `orchestration/plans/W1-08.md` `orchestration/status/W1-15.json` `orchestration/status/W1-12.json` |
...
| `critique-w1-18-19-25-codex` | done | Remediate the blocking RI-EXP02 acceptance contract in W1-25; W1-18 and W1-19 are plan-sat | `orchestration/plans/W1-18.md` `orchestration/plans/W1-19.md` `orchestration/plans/W1-25.md` `orchestration/status/W1-18.json` `orchestration/status/W1-19.json` `orchestration/status/W1-25.json` |
| `critique-wave1-16-05-20-20260809` | ? | Owner may move on to `Plan the next Wave 1 batch.` | `orchestration/status/critique-wave1-16-05-20-20260809.json` `orchestration/plans/W1-16.md` `orchestration/status/W1-16.json` `orchestration/plans/W1-05.md` `orchestration/status/W1-05.json` `orchestration/plans/W1-20.md` |
...
| `codex-wave1-plan-remediation-20260809` | ? | Owner command: Critique the current Wave 1 plans. | `orchestration/status/codex-wave1-plan-remediation-20260809.json` `orchestration/plans/W1-HUD-TOAST.md` `orchestration/status/W1-HUD-TOAST-A.json` `reports/blog-feed.jsonl` `docs/shots/2026-08-09-wave1-hud-toast-plan-remediation.svg` |
| `codex-wave1-recritique-20260809` | ? | Owner command: Remediate the current Wave 1 plan critiques. | `orchestration/status/codex-wave1-recritique-20260809.json` `orchestration/plans/W1-HUD-TOAST.md` `orchestration/status/W1-HUD-TOAST-A.json` `reports/blog-feed.jsonl` `docs/shots/2026-08-09-wave1-hud-toast-plan-recritique.svg` `docs/index.html` |
| `codex-wave1-recritique-3-20260809` | ? | Owner command: Remediate the current Wave 1 plan critiques. | `orchestration/status/codex-wave1-recritique-3-20260809.json` `orchestration/plans/W1-HUD-TOAST.md` `orchestration/status/W1-HUD-TOAST-A.json` `reports/blog-feed.jsonl` `docs/shots/2026-08-09-wave1-hud-toast-plan-recritique-3.svg` `docs/index.html` |
| `codex-wave1-remediate-20260809` | ? | Owner command: Critique the current Wave 1 plans. | `orchestration/status/codex-wave1-remediate-20260809.json` `orchestration/plans/W1-HUD-TOAST.md` `orchestration/status/W1-HUD-TOAST-A.json` `reports/blog-feed.jsonl` `docs/shots/2026-08-09-wave1-hud-toast-plan-remediation-3.svg` |
| `codex-wave1-remediate-w1-00-14-11-20260809` | ? | Owner command: Critique the current Wave 1 plans. | `orchestration/status/codex-wave1-remediate-w1-00-14-11-20260809.json` `orchestration/plans/W1-00.md` `orchestration/status/W1-00.json` `orchestration/plans/W1-14.md` `orchestration/status/W1-14.json` `orchestration/plans/W1-11.md` |
| `codex-wave1-remediate-w1-12-w1-01-w1-24-20260809` | ? | Owner command: Critique the current Wave 1 plans. | `orchestration/status/codex-wave1-remediate-w1-12-w1-01-w1-24-20260809.json` `orchestration/plans/W1-12.md` `orchestration/status/W1-12.json` `orchestration/plans/W1-01.md` `orchestration/status/W1-01.json` `orchestration/plans/W1-24.md` |
| `codex-wave1-review-editor-w1-12-w1-01-w1-24-w1-07-20260809` | ? | Owner command: Critique the current Wave 1 plans. | `orchestration/plans/W1-12.md` `orchestration/status/W1-12.json` `orchestration/plans/W1-01.md` `orchestration/status/W1-01.json` `orchestration/plans/W1-24.md` `orchestration/status/W1-24.json` |
...
| `codex-builder-w1-15-20260810` | ? | Exact critic handoff above; ordinary builder-actionable W1-15 rows are resolved. | `game/data/stealth/detection.json` `game/src/engine.js` `game/src/render/places.js` `game/src/sim/crime/state.js` `tools/harness/w1-15-r4-lights.mjs` `tools/quests/w1-15-prerequisite-ledger.mjs` |
| `codex-critic-w1-04-w1-23-w1-15` | ? | Owner should remediate the three blocking plan critiques. | `orchestration/status/codex-critic-w1-04-w1-23-w1-15.json` `orchestration/plans/W1-04.md` `orchestration/status/W1-04.json` `orchestration/plans/W1-23.md` `orchestration/status/W1-23.json` `orchestration/plans/W1-15.md` |
| `codex-critic-w1-27-00-14-11-20260809` | ? | Owner publishes this PR, then runs: Remediate the current Wave 1 plan critiques | `orchestration/status/codex-critic-w1-27-00-14-11-20260809.json` `orchestration/plans/W1-27.md` `orchestration/status/W1-27.json` `orchestration/plans/W1-00.md` `orchestration/status/W1-00.json` `orchestration/plans/W1-14.md` |
| `codex-plan-w1-04-w1-23-w1-15` | ? | Fresh independent plan criticism for W1-04, then W1-23, then W1-15. | `orchestration/status/codex-plan-w1-04-w1-23-w1-15.json` `orchestration/plans/W1-04.md` `orchestration/plans/W1-23.md` `orchestration/plans/W1-15.md` `orchestration/status/W1-04.json` `orchestration/status/W1-23.json` |
| `codex-plan-w1-09-w1-22-20260809` | ? | Owner command: Critique the current Wave 1 plans | `orchestration/plans/W1-09.md` `orchestration/status/W1-09.json` `orchestration/plans/W1-22.md` `orchestration/status/W1-22.json` `orchestration/status/codex-plan-w1-09-w1-22-20260809.json` |
| `codex-remediate-w1-04-w1-23-w1-15-20260809` | ? | Fresh independent reviewer-editors re-criticise W1-04, W1-23, and W1-15; no builder dispat | `orchestration/status/codex-remediate-w1-04-w1-23-w1-15-20260809.json` `orchestration/plans/W1-04.md` `orchestration/plans/W1-23.md` `orchestration/plans/W1-15.md` `orchestration/status/W1-04.json` `orchestration/status/W1-23.json` |
| `codex-remediate-w1-09-w1-22-w1-25-20260809` | ? | Obtain the two canonical rulings; then finish W1-09/W1-22 remediation. Send W1-25 to a fre | `orchestration/plans/W1-09.md` `orchestration/plans/W1-22.md` `orchestration/plans/W1-25.md` `orchestration/status/W1-09.json` `orchestration/status/W1-22.json` `orchestration/status/W1-25.json` |
...
| `codex-wave1-continuation-plans-20260809-b` | ? | Owner command: Critique the current Wave 1 plans | `orchestration/status/codex-wave1-continuation-plans-20260809-b.json` `orchestration/plans/W1-13.md` `orchestration/plans/W1-21.md` `orchestration/plans/W1-10.md` `orchestration/plans/W1-08.md` `orchestration/plans/W1-29.md` |
| `codex-wave1-continuation-plans-w1-16-w1-05-w1-20-20260809` | ? | Critique the current Wave 1 plans | `orchestration/plans/W1-16.md` `orchestration/plans/W1-05.md` `orchestration/plans/W1-20.md` `orchestration/status/W1-16.json` `orchestration/status/W1-05.json` `orchestration/status/W1-20.json` |
| `codex-wave1-plan-20260809` | ? | Dispatch a fresh independent plan critic for orchestration/plans/W1-02.md. | `orchestration/status/codex-wave1-plan-20260809.json` `orchestration/plans/W1-02.md` `orchestration/status/W1-02.json` `reports/blog-feed.jsonl` `docs/shots/2026-08-09-w1-02-next-batch-plan.svg` |
| `codex-wave1-plan-bundle-12-01-24-07-28-20260809` | ? | Owner command: Critique the current Wave 1 plans | `orchestration/plans/W1-12.md` `orchestration/status/W1-12.json` `orchestration/plans/W1-01.md` `orchestration/status/W1-01.json` `orchestration/plans/W1-24.md` `orchestration/status/W1-24.json` |
| `codex-wave1-plan-critic-bundle-12-01-24-07-28-20260809` | ? | Owner command: Remediate the current Wave 1 plan critiques. | `orchestration/plans/W1-12.md` `orchestration/plans/W1-01.md` `orchestration/plans/W1-24.md` `orchestration/plans/W1-07.md` `orchestration/plans/W1-28.md` `orchestration/status/W1-12.json` |
| `codex-wave1-plan-critique-20260809` | ? | Owner publishes this critique, then runs: Remediate the current Wave 1 plan critiques. | `orchestration/status/codex-wave1-plan-critique-20260809.json` `orchestration/plans/W1-HUD-TOAST.md` `orchestration/status/W1-HUD-TOAST-A.json` `reports/blog-feed.jsonl` `docs/shots/2026-08-09-wave1-hud-toast-plan-recritique-4.svg` |
...
| `W1-MAP-DEFECTS` | ? | read game/src/ui map surface + input routing; reproduce D1 through character creation on d | `orchestration/status/W1-MAP-DEFECTS.json` |
...
| `W1-DLG-WORDS` | running | read RI-DLG06/07/08, corpus Morrowind dialogue extract, then census our lines | `orchestration/status/W1-DLG-WORDS.json` |
...
| `W1-30B` | landed-pending-fresh-critic | FIRST: re-run `node tools/visual/w1-30b-roughness.mjs --tag gpu --hardware` on the pod. Th | `game/src/render/sky.js` `game/src/render/lighting.js` `game/src/render/lib/lighting-recipes.js` `tools/visual/w1-30b-air.mjs` `tools/visual/w1-30b-probe.mjs` `tools/visual/w1-30b-roughness.mjs` |
...
| `W1-30DE-critic` | running | Read W1-30D.md and w1-30e-builder.json status, plans, board.json, W1-30-EVIDENCE.md, ARBIT | `orchestration/status/W1-30DE-critic.json` |
...
| `W1-26` | ? | Fresh builder must add and run mouse+keyboard, gamepad-only, and touch-only full public-in | `orchestration/status/W1-26.json` `tools/w1-26-r3/created-by-keyboard.mjs` `reports/w1-26-builder/keyboard.json` `reports/w1-26-builder/verify.json` `reports/w1-26-builder/jrn09.json` `reports/w1-26-builder/exp01-session-protocol.json` |
...
| `W1-30-P2` | ? | Re-run clean 5ad11d22 after the parallel RunPod hardening lands, then retain Package 2 cov | `orchestration/status/W1-30-P2.json` `game/src/render/world-art.js` `game/src/render/actor.js` `game/src/world/province.js` `game/src/render/exterior.js` `game/src/render/interior.js` |
...
| `W1-30-builder-20260812` | builder-native-gpu-remediation-in-progress | Do not dispatch the critic yet. Continue native GPU repairs for the remaining red terrain, | `game/src/render/actor.js` `game/src/render/visual-foundation.js` `game/src/world/province.js` `tools/render/w1-30-gate.mjs` `orchestration/status/W1-30-builder-20260812.json` `game/src/render/renderer.js` |
...
| `W1-25-matrix-canonical-20260814` | done | None for this task. Two handoffs left for W1-25's owner, both in section 4 and 5 of the re | `orchestration/status/W1-25-MATRIX-CANONICAL-20260814.json` `tools/composition/matrix-probe.mjs` `tools/composition/stale-canonical-census.mjs` `tools/composition/w1-25-matrix-canonical-run.sh` `reports/composition/w1/matrix.json` `reports/composition/w1-25-matrix-canonical/CANONICAL-REMEASURE-20260814.md` |
...
| `W1-25-persistent-builder` | ? | Builder-owned W1-25 work is complete at 4c6ef4c. Canonical sibling owners must supply B-02 | `game/data/items/carried.json` `game/src/engine.js` `game/src/harness/api.js` `orchestration/status/W1-25-persistent-builder.json` `reports/composition/w1-25-persistent-builder/crossing-controls.json` `reports/composition/w1-25-persistent-builder/matrix-live.json` |
...
| `W1-22-reviewer-editor-fresh-20260809` | done | A different fresh reviewer-editor must review the edited W1-22 plan; no builder dispatch y | `orchestration/status/W1-22-reviewer-editor-fresh-20260809.json` |
...
| `W1-21-builder` | ? | After W1-30 lands, dispatch one production builder to deliver all builder-owned visual-clo | `orchestration/status/W1-21-builder.json` `game/data/world/readables/site-marks.json` `tools/harness/ui-pause.mjs` `tools/ui/w1-21-model-consumption.mjs` `reports/w1-21-builder/aggregate.md` `reports/w1-21-builder/ui-comparison-packs.json` |
...
| `W1-19-builder-production-20260811` | ? | Continue from the journal-corrected, hash-pinned Q17 fixture described in evidence/W1-19/q | `tools/quests/mainline-chain-floor.mjs` `tools/quests/player-wait-smoke.mjs` `tools/quests/validate-mainline-checkpoint.mjs` `tools/gamepad/pad-run.mjs` `game/src/ui/screens/wait.js` `game/src/ui/system.js` |
| `W1-19-builder-production-continuation-20260813` | ? | Publish and merge the corrected Q17/native-GPU checkpoint milestone, then continue from th | `game/src/render/exterior.js` `game/src/ui/system.js` `tools/gamepad/pad-run.mjs` `tools/quests/mainline-chain-floor.mjs` `tools/quests/validate-mainline-checkpoint.mjs` `evidence/W1-19/fixtures/resume-saxhleel-interior-intended-q17.json` |
...
| `W1-13-r5` | done | Fresh critic reruns the native aggregation in healthy browser capacity, begins at the save | `game/data/save-manifest.json` `game/src/save/state.js` `tools/journey/jrn06-death.mjs` `tools/harness/w1-13-r5-save-clock.mjs` `orchestration/status/W1-13-r5.json` |
...
| `W1-12-r3` | done | Fresh independent critic: orchestration/plans/W1-12.md §3, beginning with tools/combat/w1- | `orchestration/status/W1-12-r3.json` `game/data/combat/ai.json` `game/src/combat/ai.js` `game/src/combat/enemy.js` `tools/combat/w1-12-r3-ai-gate.mjs` `reports/w1-12-r3/DELIVERY.md` |
...
| `W1-13-codex-20260811` | done | Fresh independent critic judges the completed builder output; the native aggregate records | `orchestration/evidence/W1-13-complete.md` `orchestration/status/W1-13-codex-20260811.json` `tools/harness/w1-13-m8-roster-controls.mjs` `tools/journey/journey-run.mjs` `tools/journey/jrn06-death.mjs` |
| `W1-10-builder` | ? | Fresh critic runs tools/harness/critic-w1-10-launch.mjs and the two independent blind rows | `orchestration/status/W1-10-builder.json` `game/data/combat/movesets/axe_hatchet_pair.json` `game/data/combat/movesets/bow_chitin_recurve.json` `game/data/combat/movesets/bow_horn_sinew.json` `game/data/combat/movesets/bow_marsh_longbow.json` `game/data/combat/movesets/bow_reed_shortbow.json` |
| `W1-09-W1-22-arbiter-20260809` | ? | Owner dispatches a fresh independent reviewer-editor to re-criticise W1-09 and W1-22; no b | `corpus/00-doctrine/ARBITRATION.md` `corpus/10-combat/RI-CMB09-recovery-and-exhaustion.md` `corpus/87-audio/RI-AUD03-regional-ambience.md` `orchestration/plans/W1-09.md` `orchestration/plans/W1-22.md` `orchestration/status/W1-09.json` |
| `W1-06-build` | ? | Dispatch a fresh independent build critic; critic-owned exhaustive, blind and final-scorin | `game/src/engine.js` `game/src/render/exterior.js` `game/src/sim/camera.js` `game/src/sim/record.js` `game/src/sim/world-collision.js` `tools/camera/cam-probe.mjs` |
...
| `W1-05-builder` | awaiting-criticism | Independent critic executes the exact handoff; no builder PASS claimed. | `orchestration/status/W1-05-builder.json` `tools/world/w1-05-body-matrix.mjs` |
...
| `W1-01-r5-builder` | partial | Fresh builder must close live settlement-solid crossing, full 900-frame span pushes, and e | `orchestration/status/W1-01-r5-builder.json` `reports/w1-01-r5/builder-evidence.md` `tools/world/road-through-building.mjs` `tools/world/parapet-probe.mjs` |
| `W1-03-W1-26-W1-27-remediation-20260809` | ? | Owner command: Critique the current Wave 1 plans. | `orchestration/plans/W1-03.md` `orchestration/plans/W1-26.md` `orchestration/plans/W1-27.md` `orchestration/status/W1-03.json` `orchestration/status/W1-26.json` `orchestration/status/W1-27.json` |
| `W1-03-W1-26-W1-27-reviewer-editor-20260809-r2` | ? | Owner publishes this PR, then dispatches a fresh independent PLAN REVIEWER-EDITOR pass for | `orchestration/plans/W1-03.md` `orchestration/plans/W1-26.md` `orchestration/plans/W1-27.md` `orchestration/status/W1-03.json` `orchestration/status/W1-26.json` `orchestration/status/W1-27.json` |
| `W1-03-W1-26-W1-27-reviewer-editor-20260809-r3` | ? | Owner publishes this PR; then dispatches a fresh independent PLAN REVIEWER-EDITOR for W1-2 | `orchestration/plans/W1-03.md` `orchestration/plans/W1-26.md` `orchestration/plans/W1-27.md` `orchestration/status/W1-03.json` `orchestration/status/W1-26.json` `orchestration/status/W1-27.json` |
| `W1-03-builder` | built_awaiting_critic | Fresh independent W1-03 critic: run every native RI-WLD10 M47-M56, RI-WLD11 M57-M63, RI-VI | `orchestration/status/W1-03-builder.json` `game/data/world/traversal.json` `game/src/combat/system.js` `game/src/render/renderer.js` `game/src/sim/traversal.js` `game/src/world/field.js` |
...
| `W1-00-W1-14-W1-27-reviewer-editor-20260809-r4` | ? | Owner publishes this PR, then runs: Critique the current Wave 1 plans | `orchestration/plans/W1-00.md` `orchestration/plans/W1-14.md` `orchestration/plans/W1-27.md` `orchestration/status/W1-00.json` `orchestration/status/W1-14.json` `orchestration/status/W1-27.json` |
| `W1-00-W1-14-W1-27-reviewer-editor-20260809-r5` | ? | Owner publishes this PR, then runs: Critique the current Wave 1 plans | `orchestration/plans/W1-00.md` `orchestration/plans/W1-14.md` `orchestration/plans/W1-27.md` `orchestration/status/W1-00.json` `orchestration/status/W1-14.json` `orchestration/status/W1-27.json` |
...
| `FIRST-TEN-MINUTES-critic` | verdict-filed-FAIL-4.0-against-gate-7.0 | None from me. The verdict is filed, schema-valid, the ledger is regenerated and publish ha | `orchestration/status/FIRST-TEN-MINUTES-critic.json` `tools/harness/critic-first-ten-play.mjs` `corpus/90-verdicts/wave1/W1-FIRST-TEN-MINUTES-r1.md` `corpus/90-verdicts/wave1/W1-FIRST-TEN-MINUTES-r1.json` `corpus/90-verdicts/wave1/artifacts/first-ten-minutes/` `corpus/80-methods/RI-MTH04-measurement-integrity.md` |
