...
drift. At `e8ca45fb`: **1013 tools**, **158 reference items**,
**57 pieces in flight**.
...
|---|---|
| does a tool for this already exist? | `grep -i <word> orchestration/index/TOOLS.md` — all 1013, one line each |
