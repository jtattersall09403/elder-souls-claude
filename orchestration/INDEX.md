...
drift. At `029ff1ab`: **1063 tools**, **160 reference items**,
**62 pieces in flight**.
...
|---|---|
| does a tool for this already exist? | `grep -i <word> orchestration/index/TOOLS.md` — all 1063, one line each |
