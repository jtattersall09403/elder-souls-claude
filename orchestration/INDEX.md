...
so it cannot drift. Generated at `1f2c5aa`: 834 tools, 153 reference
...
`window.__HARNESS` — 428 verbs. `window.__ENGINE` is also published by `main.js`,
...
> **194 tools have no header comment**, so nobody can tell what they do without
