...
so it cannot drift. Generated at `9b51756`: 836 tools, 153 reference
...
`window.__HARNESS` — 437 verbs. `window.__ENGINE` is also published by `main.js`,
...
> **196 tools have no header comment**, so nobody can tell what they do without
